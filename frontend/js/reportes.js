...
function renderDashboard(data) {
  ...
  container.innerHTML = `
    <article class="metric-pill">
      ...
      <strong>${data.inventario.productos_activos}</strong>
    </article>
    <article class="metric-pill">
      <span>Stock bajo</span>
      <strong>${data.inventario.stock_bajo}</strong>
    </article>
    <article class="metric-pill">
      <span>Valor stock</span>
      <strong>${formatMoney(data.inventario.valor_stock_oro)}</strong>
    </article>
    <article class="metric-pill">
      <span>Ventas hoy</span>
      <strong>${formatMoney(data.operaciones_hoy.ventas_oro)}</strong>
    </article>
    <article class="metric-pill">
